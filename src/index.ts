...
async function main(): Promise<void> {
  ...
  const getConsultationOnlineBookingRateUseCase =
    new GetConsultationOnlineBookingRateUseCase(consultationRepository)
  ...
  const consultationController = new ConsultationController(
    ...
    getConsultationOnlineBookingRateUseCase
  )
